...
$sql="
SELECT * FROM files
WHERE filiere=:f AND semestre=:s AND matiere=:m
AND type='ressources' AND status='active'
";
...
<h1 class="page-title">🌐 Ressources complémentaires</h1>
...
<form method="GET" class="search-box">
  ...
  <input type="text" name="search" placeholder="Rechercher ressource..." value="<?= htmlspecialchars($search) ?>">
